...
static constexpr std::array<const char*, 527> locations_array__ =
  ...
  " (in 'string', line 613, column 2 to column 18)",
  " (in 'string', line 614, column 2 to column 24)",
  " (in 'string', line 615, column 2 to column 26)",
  " (in 'string', line 617, column 2 to column 14)",
  " (in 'string', line 621, column 2 to column 39)",
  " (in 'string', line 622, column 2 to column 47)",
  " (in 'string', line 623, column 2 to column 67)",
  " (in 'string', line 627, column 2 to column 23)",
  " (in 'string', line 629, column 2 to column 43)",
  " (in 'string', line 628, column 2 to column 57)",
  " (in 'string', line 633, column 2 to column 23)",
  " (in 'string', line 634, column 2 to column 71)",
  " (in 'string', line 635, column 2 to column 74)",
  " (in 'string', line 636, column 2 to column 72)",
  " (in 'string', line 637, column 22 to line 638, column 48)",
  " (in 'string', line 637, column 2 to line 638, column 48)",
  " (in 'string', line 639, column 26 to line 640, column 56)",
  " (in 'string', line 639, column 2 to line 640, column 56)",
  " (in 'string', line 641, column 36 to line 642, column 76)",
  " (in 'string', line 641, column 2 to line 642, column 76)",
  " (in 'string', line 643, column 9 to column 17)",
  " (in 'string', line 643, column 18 to column 25)",
  " (in 'string', line 643, column 2 to column 36)",
  " (in 'string', line 645, column 11 to column 18)",
  " (in 'string', line 645, column 4 to column 51)",
  " (in 'string', line 646, column 4 to column 34)",
  " (in 'string', line 644, column 24 to line 647, column 3)",
  " (in 'string', line 644, column 2 to line 647, column 3)",
  " (in 'string', line 649, column 7 to column 14)",
  " (in 'string', line 649, column 0 to column 27)",
  " (in 'string', line 657, column 22 to line 658, column 41)",
  " (in 'string', line 657, column 5 to line 658, column 41)",
  " (in 'string', line 655, column 22 to line 656, column 31)",
  " (in 'string', line 655, column 5 to line 658, column 41)",
  " (in 'string', line 653, column 22 to line 654, column 27)",
  " (in 'string', line 653, column 5 to line 658, column 41)",
  " (in 'string', line 651, column 17 to line 652, column 21)",
  " (in 'string', line 651, column 0 to line 658, column 41)",
  " (in 'string', line 661, column 2 to column 28)",
  " (in 'string', line 554, column 0 to column 15)",
  " (in 'string', line 555, column 0 to column 22)",
  " (in 'string', line 556, column 0 to column 27)",
  " (in 'string', line 558, column 6 to column 14)",
  " (in 'string', line 558, column 0 to column 30)",
  " (in 'string', line 559, column 7 to column 15)",
  " (in 'string', line 559, column 0 to column 31)",
  " (in 'string', line 560, column 0 to column 29)",
  " (in 'string', line 561, column 0 to column 29)",
  " (in 'string', line 563, column 0 to column 23)",
  " (in 'string', line 564, column 0 to column 17)",
  " (in 'string', line 566, column 0 to column 39)",
  " (in 'string', line 567, column 0 to column 43)",
  " (in 'string', line 568, column 0 to column 53)",
  " (in 'string', line 570, column 0 to column 21)",
  " (in 'string', line 571, column 0 to column 23)",
  " (in 'string', line 573, column 7 to column 14)",
  " (in 'string', line 573, column 0 to column 21)",
  " (in 'string', line 574, column 7 to column 14)",
  " (in 'string', line 574, column 0 to column 19)",
  " (in 'string', line 575, column 6 to column 13)",
  " (in 'string', line 575, column 0 to column 28)",
  " (in 'string', line 580, column 0 to column 29)",
  " (in 'string', line 583, column 7 to column 15)",
  " (in 'string', line 583, column 0 to column 37)",
  " (in 'string', line 584, column 7 to column 13)",
  " (in 'string', line 584, column 0 to column 35)",
  " (in 'string', line 589, column 6 to column 14)",
  " (in 'string', line 589, column 23 to column 30)",
  " (in 'string', line 589, column 32 to column 33)",
  " (in 'string', line 589, column 0 to column 44)",
  " (in 'string', line 590, column 7 to column 14)",
  " (in 'string', line 590, column 16 to column 17)",
  " (in 'string', line 590, column 0 to column 27)",
  " (in 'string', line 592, column 7 to column 15)",
  " (in 'string', line 592, column 16 to column 23)",
  " (in 'string', line 592, column 0 to column 33)",
  " (in 'string', line 593, column 7 to column 14)",
  " (in 'string', line 593, column 0 to column 23)",
  " (in 'string', line 604, column 4 to column 29)",
  " (in 'string', line 605, column 4 to column 37)",
  " (in 'string', line 606, column 4 to column 52)",
  " (in 'string', line 603, column 24 to line 607, column 3)",
  " (in 'string', line 603, column 2 to line 607, column 3)",
  " (in 'string', line 602, column 7 to line 609, column 1)",
  " (in 'string', line 597, column 4 to column 29)",
  " (in 'string', line 598, column 4 to column 37)",
  " (in 'string', line 599, column 4 to column 42)",
  " (in 'string', line 596, column 24 to line 600, column 3)",
  " (in 'string', line 596, column 2 to line 600, column 3)",
  " (in 'string', line 595, column 17 to line 602, column 1)",
  " (in 'string', line 595, column 0 to line 609, column 1)",
  " (in 'string', line 613, column 9 to column 10)",
  " (in 'string', line 621, column 18 to column 35)",
  " (in 'string', line 622, column 18 to column 39)",
  " (in 'string', line 623, column 18 to column 49)",
  " (in 'string', line 627, column 9 to column 10)",
  " (in 'string', line 629, column 9 to column 10)",
        ...
        "assigning variable beta_ind");
      {
        ...
        for (int j = 1; j <= (n_quad + 1); ++j) {
          ...
          stan::model::assign(eta_quad,
            stan::math::add(mu_ind, stan::math::transpose(f_ind)),
